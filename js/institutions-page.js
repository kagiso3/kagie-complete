(function () {
  ...
  async function saveInstitution() {
    ...
    $("institutionSaveBtn").disabled = true;
    ...
    try {
      ...
      $("institutionSaveBtn").disabled = false;
    }
  }
  ...
  function bindEvents() {
    ...
    $("institutionsRefreshBtn")?.addEventListener("click", refresh);
    $("institutionsSignOut")?.addEventListener("click", () => state.api.logoutReal?.() || state.api.logout?.());
    $("institutionSaveBtn")?.addEventListener("click", saveInstitution);
    $("institutionsRows")?.addEventListener("click", (event) => {
      ...
      if (button.dataset.action === "toggle") toggleVisibility(institutionId);
      if (button.dataset.action === "delete") deleteInstitution(institutionId);
    });
