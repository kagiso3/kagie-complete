...
do $$
declare
  v_email text := 'assistant1@kagie.app';
  v_password text := 'Assistant@05';
  v_full_name text := 'Assistant One';
  v_phone text := '0712345678';
  v_user_id uuid;
begin
  select id
    into v_user_id
...
where lower(email) = 'assistant1@kagie.app';
