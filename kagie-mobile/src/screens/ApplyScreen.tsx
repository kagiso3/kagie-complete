  ...
  return (
    <ScreenScroll>
      ...
      <Card>
        ...
        <Button label={syncing ? "Saving..." : "Save learner details"} onPress={handleSaveLearner} />
      </Card>
      ...
      <Card>
        ...
        <Button label={syncing ? "Saving..." : "Save guardian details"} onPress={handleSaveParent} />
      </Card>
      ...
      <Card>
        ...
        <Button label={syncing ? "Saving..." : "Save school details"} onPress={handleSaveSchool} />
      </Card>
      ...
      <Card>
        ...
        <Button label={syncing ? "Saving..." : "Save marks"} onPress={handleSaveMarks} />
      </Card>
      ...
      <Card>
        ...
        <View style={styles.wrapRow}>
          {availableInstitutions.slice(0, 8).map((item) => (
            <Chip key={item.id} label={item.name} active={institution.institutionName === item.name} onPress={() => updateInstitution("institutionName", item.name)} />
          ))}
        </View>
        ...
        <Button label={syncing ? "Adding..." : "Add institution"} onPress={handleAddInstitution} />
      </Card>
        ...
        {(draft.institutions || []).length ? (
          draft.institutions.map((item) => (
            <View key={item.id} style={styles.shortlistItem}>
              ...
              <Pressable onPress={() => handleRemoveInstitution(item.id)}>
                <Text style={styles.removeText}>Remove</Text>
              </Pressable>
            </View>
          ))
